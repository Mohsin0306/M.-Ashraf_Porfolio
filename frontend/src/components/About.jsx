      ...
      <div className="max-w-4xl mx-auto">
        <FadeIn>
          <div className="flex items-center gap-3 mb-6">
            <span className="px-3 py-1 rounded-full bg-[var(--accent-20)] text-[var(--accent)] text-sm font-bold">01</span>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            <div className="flex items-start gap-4 p-6 rounded-2xl bg-white/60 border border-[var(--accent-20)] hover:border-[var(--accent-40)] transition-colors">
              <span className="p-3 rounded-xl bg-[var(--accent-15)] text-[var(--accent)] shrink-0">
