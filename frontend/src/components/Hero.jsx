    ...
    <section className="min-h-screen flex flex-col items-center justify-center px-8 relative overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          style={{ background: 'linear-gradient(135deg, #FA8112 0%, #FFB366 50%, #FA8112 100%)' }}
          animate={{
            x: [0, 80, 0],
            y: [0, -60, 0],
            scale: [1, 1.1, 1],
        ...
        <motion.div
          ...
          style={{ background: 'linear-gradient(45deg, #FA8112 0%, #F5E7C6 100%)' }}
          animate={{
            x: [0, 40, -30, 0],
            y: [0, 50, -40, 0],
          }}
      ...
      <FadeIn className="relative z-10 flex flex-col items-center text-center max-w-3xl">
        <div className="w-40 h-40 md:w-52 md:h-52 rounded-full overflow-hidden mb-8 ring-4 ring-[#FA8112]/30 shadow-2xl flex items-center justify-center bg-transparent">
          <img
          ...
          />
          <div className="hidden w-full h-full items-center justify-center bg-transparent text-[#FA8112] text-5xl font-bold">
            MA
          </div>
        </div>
        <p className="text-[#FA8112] font-semibold text-sm uppercase tracking-[0.2em] mb-4">
